...
export const GET_UNFAVORITE_MOVIES_REQUEST = "GET_UNFAVORITE_MOVIES_REQUEST";
export const GET_FAVORITE_MOVIES_SUCCESS = "GET_FAVORITE_MOVIES_SUCCESS";
export const GET_UNFAVORITE_MOVIES_SUCCESS = "GET_UNFAVORITE_MOVIES_SUCCESS";
export const GET_FAVORITE_MOVIES_FAIL = "GET_FAVORITE_MOVIES_FAIL";
export const GET_UNFAVORITE_MOVIES_FAIL = "GET_UNFAVORITE_MOVIES_FAIL";
export const GET_FAVORITE_MOVIES_RESET = "GET_FAVORITE_MOVIES_RESET";
export const GET_UNFAVORITE_MOVIES_RESET = "GET_UNFAVORITE_MOVIES_RESET";

export const DELETE_FAVORITE_MOVIES_REQUEST = "DELETE_FAVORITE_MOVIES_REQUEST";
export const DELETE_UNFAVORITE_MOVIES_REQUEST = "DELETE_UNFAVORITE_MOVIES_REQUEST";
export const DELETE_FAVORITE_MOVIES_SUCCESS = "DELETE_FAVORITE_MOVIES_SUCCESS";
export const DELETE_UNFAVORITE_MOVIES_SUCCESS = "DELETE_UNFAVORITE_MOVIES_SUCCESS";
export const DELETE_FAVORITE_MOVIES_FAIL = "DELETE_FAVORITE_MOVIES_FAIL";
export const DELETE_UNFAVORITE_MOVIES_FAIL = "DELETE_UNFAVORITE_MOVIES_FAIL";
export const DELETE_FAVORITE_MOVIES_RESET = "DELETE_FAVORITE_MOVIES_RESET";
export const DELETE_UNFAVORITE_MOVIES_RESET = "DELETE_UNFAVORITE_MOVIES_RESET";
...
export const UNLIKE_MOVIE_RESET = "UNLIKE_MOVIE_RESET";
