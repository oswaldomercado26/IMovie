...
import mediaApi from "../api/modules/media.api";//funciona para traer la informacion de nuestras peliculas
...
//crear efecto para el scroll y se ajuste a la medida
  useEffect(() => {
