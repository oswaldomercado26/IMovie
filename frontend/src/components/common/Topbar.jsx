...
import { setAddModalOpen } from "../../redux/features/addModalSlice";
import { setThemeMode } from "../../redux/features/themeModeSlice";
import Logo from "./Logo";
import UserMenu from "./UserMenu";
import Sidebar from "./Sidebar";
//crear menu para todos los usuarios
...
//crear opciones para el topbar del usuario
const Topbar = () => {
      ...
      <ScrollAppBar>
        <AppBar elevation={1} sx={{ zIndex: 9999 }}>
          <Toolbar sx={{ alignItems: "center", justifyContent: "space-between" }}>
            ...
            {/* user menu  su principal funcion es mandar a llamar a la funcion de la ventana modal*/}
